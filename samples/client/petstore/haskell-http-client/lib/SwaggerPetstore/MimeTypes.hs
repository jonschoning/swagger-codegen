...
-- | @BL.fromStrict@
instance MimeRender MimeOctetStream B.ByteString where mimeRender _ = BL.fromStrict
-- ** MimeUnrender Class
...
-- | @P.Right . BL.toStrict@
instance MimeUnrender MimeOctetStream B.ByteString where mimeUnrender _ = P.Right . BL.toStrict
